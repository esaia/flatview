...
class Project extends Model
{
    ...
    // Handles both a plain file path (Filament FileUpload) and a JSON imageInterface
    // array (Vue canvas editor). Reads: JSON-decode if valid JSON, else return raw string.
    // Writes: JSON-encode if array, else store raw string.
