...
<template>
    <AppLayout active-page="about">
        ...
        <div class="flex flex-col justify-center px-8 md:px-16" style="min-height: 70vh;">
            <p style="font-size: clamp(40px, 5vw, 72px); font-weight: 300; line-height: 1.1;" class="text-black max-w-4xl">
        ...
        <!-- Section 2: Pinned horizontal scroll gallery (JS-driven fixed positioning) -->
        <div ref="gallerySection" style="height: 600vh; position: relative;">
            <div
        ...
        <!-- Section 3: Stats — label left, numbers centered right -->
        <div class="relative px-8 md:px-16 pt-24 pb-24">
            <p class="absolute left-8 md:left-16 top-24 text-[11px] tracking-[0.15em] uppercase font-medium text-black">
                Stats & Facts
            </p>
            <div class="flex flex-col items-center">
                <div
                    ...
                    :key="i"
                    class="py-16 border-t border-black/10 w-full text-center"
                >
                    <p class="font-light leading-none tracking-tight text-black mb-4" style="font-size: clamp(60px, 8vw, 120px);">
                        {{ stat.value }}
                    </p>
        ...
        <div style="background: #f0ebe3;" class="px-8 md:px-16 py-32">
            <p class="text-[17px] leading-loose" style="color: #2a2520;">
            ...
            <p class="text-[17px] leading-loose mt-6" style="color: #2a2520;">
        ...
        <div class="pt-32 pb-64 px-16 flex flex-col items-center justify-center text-center">
            <h2 class="font-light leading-none tracking-tight text-black mb-6" style="font-size: clamp(48px, 7vw, 96px);">
