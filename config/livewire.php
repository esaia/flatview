...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        'rules' => ['required', 'file', 'max:262144'],         // 256MB — increased from default 12MB for video uploads
        ...
        'max_upload_time' => 15, // Max duration (in minutes) before an upload is invalidated — increased for large video files
